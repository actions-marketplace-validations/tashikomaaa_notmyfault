...
The others: `NOTMYFAULT_SUITES`, `NOTMYFAULT_MODE`, `NOTMYFAULT_TOLERATE`, `NOTMYFAULT_QUARANTINE`, `NOTMYFAULT_HISTORY_BRANCH`, `NOTMYFAULT_COMMENT`, `NOTMYFAULT_ANNOTATIONS`, `NOTMYFAULT_FLAKY_ISSUES`, `NOTMYFAULT_MENTION_OWNERS`, `NOTMYFAULT_ASSIGN_OWNERS`, `NOTMYFAULT_MISSING_TESTS`, `NOTMYFAULT_RERUN_FLAKY`, `NOTMYFAULT_RECORD` and `NOTMYFAULT_WINDOW`. Multi-line values, like several suites, work in YAML:
